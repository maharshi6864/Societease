					...
					<div class="modal-content">
								...
								<div class="row mb-3">
									<div class="col-lg-12">
										<label for="member-name" class="col-form-label">Member
											...
											class="form-control" id="member-name" name="memberName" />
									</div>
								</div>
								<div class="row mb-3">
									<div class="col-lg-12">
								...
								<div class="row mb-3">
									<div class="col-lg-12">
										<div class="form-group">
											<label class="m-0">File upload</label> <input type="file"
												name="memberFile" class="file-upload-default">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-light" data-dismiss="modal"
								onclick="emptyForm()">Close</button>
						</div>
						</form>
					</div>
				</div>
			...
			<div class="modal fade" id="exampleModal-3" tabindex="-1"
				...
				<div class="modal-dialog modal-lg" role="document">
					...
					<form method="post" action="saveMembers"
								enctype="multipart/form-data"
								onsubmit="return checkMemberDetialsInTable();">
						<div class="modal-header">
								...
								<div class="row mb-3">
									<div class="col-lg-4">
										<label class="col-form-label" style="font-weight: 700"
											for="member-form-name">Member Name : </label> <input
											class="form-control" placeholder="Type Member Name"
											id="member-form-name" /> <span id="memberName1-warning"
											style="color: #dc3545; font-size: 12px; display: none">Please
											Enter Member Name !</span> <span id="memberName2-warning"
											style="color: #dc3545; font-size: 12px; display: none">Please
											Enter Valid Member Name!</span>

									</div>
									<div class="col-lg-4">
										<label class="col-form-label" style="font-weight: 700"
											for="member-form-phone">Member PhoneNo: </label> <input
											class="form-control" placeholder="Type Member Phone"
											id="member-form-phone" /> <span id="memberPhone1-warning"
											style="color: #dc3545; font-size: 12px; display: none">Please
											Enter Member Phone no !</span> <span id="memberPhone2-warning"
											style="color: #dc3545; font-size: 12px; display: none">Please
											Enter Valid Member Phone no !</span>
									</div>
									<div class="col-lg-3 mb-1">
										<label class="col-form-label" style="font-weight: 700"
											for="member-form-email">Member Email Address: </label>
										<div class="inputcontainer">
											<input type="text" placeholder="Type Member Email Address"
												id="member-form-email" class="form-control used-email"
												placeholder="type me" />
											<div class="icon-container" id="email-inp-loader">
												<i class="loader"></i>
											</div>
										</div>
										<span id="memberEmail1-warning"
											style="color: #dc3545; font-size: 12px; display: none">Please
											Enter Member Email !</span> <span id="memberEmail2-warning"
											style="color: #dc3545; font-size: 12px; display: none">Please
											Enter Valid Email Address !</span> <span id="memberEmail3-warning"
											style="color: #dc3545; font-size: 12px; display: none">Email
											Entered is already in use !</span>

									</div>
									<div class="col-lg-1 " style="padding-top: 1.7rem;">
										<button class="btn btn-primary" type="button"
											style="padding: 0.45rem 1.25rem;" id="add-member-submit"
											onclick="addMemberToTable()">Add</button>
									</div>
								</div>
								<div class="row">
									<div class="col-12" style="height: 244px; max-height: 242px">
										<div class="table-responsive"
											...
											<table class="table table-bordered">
												...
												<tbody id="member-table">
													<tr>
														<td colspan="6"><div
																style="display: flex; justify-content: center; align-items: center; padding: 5rem 0rem;">
																<p>Add Memebers</p>
															</div></td>
													</tr>
												</tbody>
						...
						<div class="modal-footer">
							<button class="btn btn-primary" type="submit" 
								id="submit-model">Submit</button>
							<button type="button" class="btn btn-light" data-dismiss="modal"
								onclick="emptyAddMemberForm()">Close</button>
						</div>
						</form>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-6">
							<h3 class="main-title d-flex align-items-center">
								<i class="mdi mdi-account-multiple icon-md mr-2 mt-1 "></i>Members
							</h3>
						...
						<div class="col-6 d-flex justify-content-end" style="">
							...
							<button type="button" class="btn btn-primary btn-sm"
								...
								style="padding: 0.282rem 1rem !important; height: 2.55rem">Add
								Members</button>
						</div>
					</div>
								...
								<div id="collapse-3-${j.count}" class="collapse" role="tabpanel"
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-10">
												<div class="row mb-2">
													<div class="col-3" style="font-weight: 700">Phone
														Number :</div>
													<div class="col-8">${i.memberPhoneNo}</div>
												</div>
												<div class="row mb-2">
													<div class="col-3" style="font-weight: 700">Email
														Address :</div>
												...
												<div class="row mb-2 mt-3">
													<div class="col-md-3">
														<button class="btn btn-sm btn-outline-info mr-1"
															...
															onclick="editMember(${i.id})">Edit</button>
