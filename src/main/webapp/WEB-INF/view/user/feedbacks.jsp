    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-6">
                        <h3 class="main-title d-flex align-items-center"><i
                                class="mdi mdi-star-circle icon-md mr-2 mt-1 "></i>Feedbacks</h3>
                ...
                <!-- Check if feedbackVoList is empty -->
                <c:choose>
                    <c:when test="${empty feedbackVoList}">
                        <div class="card border border-0" style="min-height: 68vh;">
                            ...
                            <div class="card-body p-0">
                                <div class="row">
                                    <c:forEach items="${feedbackVoList}" var="i" varStatus="j">
                                        <div class="col-md-6" style="background: none;margin:10px 0px 10px 0px;">
                                            <div class="border border-1"
                                                 style="text-align: center; border-radius: 10px !important; padding: 10px;">
                                                <div class="row d-flex align-items-start">
                                                    <div class="col-1 text-left mr-4">
                                                        <img src="/adminResources/image/avatar.png"
                                                             alt="profile"
                                                    ...
                                                    <div class="col-6 text-left ml-2">
                                                        <div>
                                                            <p style="font-size: 15px !important;">
                                                                <b>${i.ownerVo.ownerName}</b></p>
                                                        </div>
                                                        <div>
                                                            <div class="br-wrapper br-theme-fontawesome-stars">
                                                                <select autocomplete="off" style="display: none;">
                                                                    <option value="1">1</option>
                                                                    <option value="2">2</option>
                                                                    <option value="3">3</option>
                                                                    <option value="4">4</option>
