<%@ page contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        ...
        <div class="container-scroller">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <div class="row d-flex align-content-center mb-3">
                            <div class="col-6">
                                <h3 class="main-title d-flex align-items-center"> <i
                                        class="mdi mdi-cash-multiple icon-md mr-2 mt-0 "></i>Maintenance</h3>
                            ...
                            <div class="col-3">
                                <div class="row ">
                                    <div class="col-12 d-flex justify-content-end"><label
                                            class="col-form-label"></label></div>
                                </div>
                                    ...
                                    <div class="card-body p-0 border border-0" id="container_content">
                                        <div id="bordered-div">
                                            ...
                                            <div class="container-fluid d-flex justify-content-between">
                                                ...
                                                <div class="col-lg-3 pr-0 d-flex flex-column align-items-end">
                                                    ...
                                                    <p class="text-right" style="width: 70%"><span><b
                                                            ...
                                                            id="block-name"></span><span
                                                            id="house-number"></span><br><span
                                                            id="owner-address"></span></p>
                                                </div>
                                            </div>
                                            <div class="container-fluid d-flex justify-content-between">
                                                <div class="col-lg-3 pl-0">
                                                    <p class="mb-0 mt-5">Invoice Date : <span id="invoice-date"></span>
                                                    </p>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table" style="">
                                                        <thead>
                                                            <tr class="bg-dark text-white"
                                                                ...
                                                                <th
                                                                    style="color: #ffffff !important;background-color: #030303 !important;">
                                                                    No
                                                                </th>
                                                                <th
                                                                    style="color: #ffffff !important;background-color: #030303 !important;">
                                                        ...
                                                        <tbody id="maintenance-table-view">
                                                            <tr>
                                                                <th style="text-align: center;padding: 100px"
                                                                    colspan="3">
                                            ...
                                            <div class="container-fluid mt-5 w-100 "
                                                ...
                                                <h4 class="text-right mb-0">Total : &#8377;<span
                                                        id="amount-total">0</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="container-fluid w-100">
                                            <button onclick="printInvoice()" id="print-button"
                                                class="btn btn-primary float-right mt-4 ml-2" style="display:none"><i
                                                    class="mdi mdi-printer mr-1"></i>Print
                                            </button>
                                            <button onclick="payMaintenance()" id="pay-button"
                                                class="btn btn-primary float-right mt-4 ml-2" style="display:none"><i
            ...
            <!-- container-scroller -->
            <!-- base:js -->
            <script src="<%=request.getContextPath()%>/adminResources/js/maintenanceUser.js"></script>
            <script src="<%=request.getContextPath()%>/adminResources/js/userOnloadEvents.js"></script>
