                ...
                <%-- <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>--%>
                    <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        ...
                        <%-- Owner Maintenance Start--%>
                            ...
                            <div class="modal fade" id="exampleModal-owner-maintenance" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-body p-3 pt-2 pb-2">
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <label for="" class="col-form-label mb-1"
                                                        style="font-weight: 700">Maintenance Year</label>
                                                    <select name="" id="maintenance-year"
                                                        onchange="getOwnerMaintenanceInfo()" class="form-control"
                                                        style="width: 20%">
                            ...
                            <%-- Owner Maintenance End--%>
                                ...
                                <%-- Parking Allotment Form Start --%>
                                    <div class="modal fade" id="exampleModal-owner-parking" tabindex="-1" role="dialog"
                                        aria-labelledby="ModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl" role="document">
                                            <div class="modal-content ">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-dialog modal-xl" role="document">
                                                    <div class="modal-content ">
                                                        ...
                                                        <div class="modal-body p-1 pt-2">
                                                            <div class="row">
                                                                <div class="col-12"
                                                                    style="height: 330px; max-height: 500px">
                                                                    <div class="table-responsive"
                                                                        style="max-height: 100% !important; scrollbar-width: none">
                                                                        <table class="table ">
                                                                            <thead>
                                                ...
                                                <%-- Owner Edit Model Starts--%>
                                                    <div class="modal fade" id="exampleModal-3" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="ModalLabelEditOwner">
                                                                        Edit Owner</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class=" row">
                                                                        <input type="hidden" class="form-control"
                                                                            id="owner-edit-id" />
                                                                        <div class="col-lg-6">
                                                                            <label for="owner-edit-block-no"
                                                                                class="col-form-label">Block Name :
                                                                            </label>

                                                                            <select class="form-control"
                                                                                id="owner-edit-block-no">
                                                                                <option id="block" disabled selected>- -
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <label for="owner-edit-floor-no"
                                                                                class="col-form-label">Floor No :
                                                                            </label>

                                                                            <select class="form-control"
                                                                                id="owner-edit-floor-no">
                                                                                <option id="floor" disabled selected>- -
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class=" row">
                                                                        <div class="col-lg-12">
                                                                            <label for="owner-edit-house-no"
                                                                                class="col-form-label">Owner House No :
                                                                            </label>
                                                                    ...
                                                                    <div class=" row">
                                                                        <div class="col-lg-12">
                                                                            <label for="owner-edit-name"
                                                                                class="col-form-label">Owner Name :
                                                                            </label>

                                                                            <input type="text" class="form-control"
                                                                                id="owner-edit-name" />
                                                                            <span id="nameEdit1-warning"
                                                                                style="color: #dc3545;font-size:12px;display: none">Please
                                                                                Enter Owner Name !</span>
                                                                            <span id="nameEdit2-warning"
                                                                                style="color: #dc3545;font-size:12px;display: none">Please
                                                                                Enter Valid Owner Full Name!</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class=" row">
                                                                        <div class="col-lg-12">
                                                                            <label for="owner-edit-email"
                                                                                class="col-form-label">Owner Email
                                                                                Address :
                                                                            </label>

                                                                            <input type="text" class="form-control"
                                                                                id="owner-edit-email" />
                                                                            <span id="emailEdit1-warning"
                                                                                style="color: #dc3545;font-size:12px;display: none">Please
                                                                                Enter Owner Email Address!</span>
                                                                            <span id="emailEdit2-warning"
                                                                                style="color: #dc3545;font-size:12px;display: none">Please
                                                                                Enter Valid Owner Email Address !</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                        ...
                                                        <div class="modal fade" id="exampleModal-1" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-xl" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="ownerName" method="post"
                                                                        onsubmit="return validateOwnerAddForm();"
                                                                        class="model-form">
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-4">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <label for="number-of-floors"
                                                                                        class="col-form-label">Floor:
                                                                                    </label>
                                                                                    <select class="form-control"
                                                                                        id="number-of-floors"
                                                                                        name="floorNumber"
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    ...
                                                                                    <input type="text" name=""
                                                                                        ...
                                                                                        id="number-of-house" disabled />
                                                                                </div>
                                                                            </div>
                                                                            <div class="row mt-3"
                                                                                id="house-numbers-label"></div>
                                                                            <div class="row ">
                                                                                <div class="col-lg-12"
                                                                                    id="house-numbers-ownwers"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button class="btn btn-primary"
                                                        ...
                                                        <div class="main-panel">
                                                            <div class="content-wrapper">
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <h3
                                                                            class="main-title d-flex align-items-center">
                                                                            <i
                                                                                class="mdi mdi-human-child icon-md mr-1 mt-1 "></i>Owners
                                                                        </h3>
                                                                        <nav aria-label="breadcrumb d-flex align-content-center"
                                                                            class="bread">
                                                                            <ol
                                                                                class="breadcrumb border-0 p-0 d-flex align-content-center">
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header pb-3 pt-3">
                                                                        <div class="row mb-2">
                                                                            <div class="col-lg-3">
                                                                                <label for="blockSearch"
                                                                                    class="col-form-label card-title pt-0 mb-1 mt-2">Block
                                                                                    Name:
                                                                                </label>
                                                                                <select class="form-control"
                                                                                    name="blockId" id="blockSearch"
                                                                            ...
                                                                            <div class="col-lg-3">
                                                                                <label for="number-of-floors-search"
                                                                                    class="col-form-label card-title pt-0 mb-1 mt-2 text-">Floor
                                                                                    No:
                                                                                </label>
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <table class="table ">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                ...
                                                                                                <th>House Number</th>
                                                                                                <th>Owner Name</th>
                                                                                                <th>Owner Email Address
                                                                                                </th>
                                                                                                <th>Member Info</th>
                                                                                                <th>Parking Allotment
                                                                                                </th>
                                                                                                <th>Manage Maintenance
                                                                                                </th>
                                                                                                <th>Edit</th>
                                                                                            </tr>
                                                                                        </thead>
                                                                                        <tbody id="owner-table">
                                                                                            <tr>
                                                                                                <td colspan="6"
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="col-md-12 col-sm-12 border border-0">
                                                                                                        <div
                                                                                                            class="loader-demo-box border border-0">
