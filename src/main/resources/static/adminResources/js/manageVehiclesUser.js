...
function editVehicleAddButton(vehicleObjs) {
  if (vehicleObjs.length === 0) {
    document
      .getElementById("two-wheeler-v")
      .classList.add("justify-content-center");
    document.getElementById(
      "two-wheeler-v"
    ).innerHTML = `<h3 style="margin:5rem 0px">No Two Wheelers Added</h3>`;

    document
      .getElementById("four-wheeler-v")
      .classList.add("justify-content-center");
    document.getElementById(
      "four-wheeler-v"
    ).innerHTML = `<h3 style="margin:5rem 0rem">No Four Wheelers Added</h3>`;
    return;
  }
  if (
    twoWheelerCounter + fourWheelCounter ==
    vehicleObjs[0].ownerVo.blockVo.typeOfHouse * 2
  ) {
    document.getElementById("vehicle-add-button").style.display = "none";
  }

  if (twoWheelerCounter === 0) {
    console.log("no two wheelers");
    document
      .getElementById("two-wheeler-v")
      .classList.add("justify-content-center");
    document.getElementById(
      "two-wheeler-v"
    ).innerHTML = `<p class="m-4 ">No Two Wheelers Added</p>`;
  }
  if (fourWheelCounter === 0) {
    ...
    document.getElementById(
      "four-wheeler-v"
    ).innerHTML = `<p class="m-4 ">No Four Wheelers Added</p>`;
  }
  ...
  if (twoWheelerCounter == vehicleObjs[0].ownerVo.blockVo.typeOfHouse) {
    ...
    ).innerHTML = `Only Four Wheelers will be allowed to add`;
    document.getElementById(
      "vehicle-type"
    ).innerHTML = `<option value="" selected disabled>Select Vehicle Type</option> 
  ...
  if (fourWheelCounter == vehicleObjs[0].ownerVo.blockVo.typeOfHouse) {
    ...
    document.getElementById(
      "vehicle-type-warning"
    ).innerHTML = `Only Two Wheelers will be allowed to add`;
    document.getElementById(
      "vehicle-type"
    ).innerHTML = `<option value="" selected disabled>Select Vehicle Type</option>
...
function changeFormValue(vehicleObj) {
  let presentOptionsinSelect =
    document.getElementById("vehicle-type").childNodes;
  ...
  document.getElementById("vehicle-number-plate").value =
    vehicleObj.vehicleNumberPlate;
  document.getElementById("vehicle-rc-number").value =
    vehicleObj.vehicleRCNumber;
